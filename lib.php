...
class AppConfig
{
    ...
    public  $appId = 'APP-ID';
    public  $appUid = 'APP-UID';
    public  $secretKey = 'SECRET-KEY';

    public  $appBaseUrl = 'APP-BASE-URL';

    public  $moyskladVendorApiEndpointUrl = 'https://online.moysklad.ru/api/vendor/1.0';
    public  $moyskladJsonApiEndpointUrl = 'https://online.moysklad.ru/api/remap/1.2';
